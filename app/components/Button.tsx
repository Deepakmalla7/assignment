...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantClasses: Record<string, string> = {
      ...
      outline: "border-2 border-pink-500 text-pink-500 hover:bg-pink-50 disabled:border-pink-300 disabled:text-pink-300",
    };
    ...
    // If asChild is true, treat children as a single child element and apply className to it
